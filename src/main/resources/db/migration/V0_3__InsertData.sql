...
INSERT INTO item (id,name,description,value,quantity)
values (nextval('item_seq'),'Osso de Borracha P', 'Osso de borracha para cachorros de pequenos porte, 120gr', 8, 20);
INSERT INTO item (id,name,description,value,quantity)
values (nextval('item_seq'),'Osso de Borracha M', 'Osso de borracha para cachorros de médio porte, 180gr', 14, 30);
INSERT INTO item (id,name,description,value,quantity)
values (nextval('item_seq'),'Osso de Borracha G', 'Osso de borracha para cachorros de grande porte, 220gr', 21, 18);
INSERT INTO item (id,name,description,value,quantity)
values (nextval('item_seq'),'Bebedouro Pequeno Azul', 'Bebedouro azul para raças pequenas', 5, 10);
INSERT INTO item (id,name,description,value,quantity)
values (nextval('item_seq'),'Bebedouro Médio Azul', 'Bebedouro azul para raças de médio porte', 8, 20);
INSERT INTO item (id,name,description,value,quantity)
values (nextval('item_seq'),'Bebedouro Grande Azul', 'Bebedouro azul para raças grandes', 12, 5);
INSERT INTO item (id,name,description,value,quantity)
values (nextval('item_seq'),'Shampoo para Cachorros e Gatos NEUTRO', 'Shampoo Neutro para cães e gatos, ideal para todos os tipos de pelo', 33, 19);
